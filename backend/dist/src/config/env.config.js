...
const envSchema = zod_1.z.object({
    ...
    META_CLIENT_ID: zod_1.z.string().default('mock_meta_client_id'),
    META_CLIENT_SECRET: zod_1.z.string().default('mock_meta_client_secret'),
    META_REDIRECT_URI: zod_1.z.string().default('http://localhost:5000/api/v1/integrations/meta/callback'),
    SHOPIFY_API_KEY: zod_1.z.string().default('mock_shopify_api_key'),
    SHOPIFY_API_SECRET: zod_1.z.string().default('mock_shopify_api_secret'),
    SHOPIFY_REDIRECT_URI: zod_1.z.string().default('http://localhost:5000/api/v1/integrations/shopify/callback'),
